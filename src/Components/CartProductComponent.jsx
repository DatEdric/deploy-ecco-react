...
export default function CartProductComponent() {
    const { showCart, setShowCart, totalPrices } = useContext(Context);
    ...
    return (
        <>
            <Modal show={showCart} onHide={handleClose}>
                ...
                {isEmpty(currentAcc) == true ? (
                    <>
                        <p className="title-empty">Không có sản phẩm trong giỏ</p>
                        <img src="https://www.fudcoshop.com/pub/static/frontend/MageBig/martfury_layout04/en_GB/images/empty-cart.svg" alt="" className="cart-empty" />
                    </>
                ) : (
                    <>
                        <Modal.Body>
