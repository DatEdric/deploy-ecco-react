...
export default function HomePageComponent({ value }) {
    ...
    const golf = golfProduct.map((a) => a.products.slice(4, 8));
        ...
        <>
            ...
            <Row className="new_products mb-5" lg={4} md={2} sm={1} xs={1}>
                {nuproduct.map((item) =>
                    item.map((value, key) => (
                        <Col>
                            <Card className="item border-0" key={key} onClick={() => handledetail(value)}>
            ...
            <Row className="golf_intro d-flex" lg={3} md={1} sm={1} xs={1}>
                <Col className="mb-3">
                    <Card className="img_hover border-0">
                        <Card.Img
                            variant="top"
                            className="img-banner-golf"
                            src="https://file.hstatic.net/1000143422/file/banner_1200x1200_c6a48a8507924ba084c41ee4869c1928.png"
                        />
                    </Card>
                </Col>
                <Col className="mb-3">
                    <Card className="img_hover border-0">
                        <Card.Img
                            variant="top"
                            className="img-banner-golf"
                            src="https://file.hstatic.net/1000143422/file/banner_1200x1200___1_d17a397ad4c740b299e42077ebf86e20.png"
                        />
                    </Card>
                </Col>
                <Col className="mb-3">
                    <Card className="img_hover border-0">
                        <Card.Img
                            variant="top"
                            className="img-banner-golf"
                            src="https://file.hstatic.net/1000143422/file/banner_1200x1200___2_7abf85a91029463d94c7c7c6e6b55450.png"
                        />
                    </Card>
                </Col>
            </Row>
