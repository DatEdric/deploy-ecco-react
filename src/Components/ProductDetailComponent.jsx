...
export default function ProductDetailComponent() {
    ...
    const addToCart = () => {
        ...
        const availProduct = currentAccount.products?.filter(
            (item) => item.product.name === state.product?.name && item.product?.size === state.product?.size
        );
        console.log(availProduct, "avai");
        if (state.product.category === "leather" || state.product.type === "accessory") {
            state.product.size = "XL";
            // co roi
...
//         }
//         state["size"] = size;
//         const availProduct = currentAccount?.products?.filter((item) => item.name === state?.name && item.size === state?.size);
//         console.log(availProduct, "avai");
//         if (state.size == 0) {
//             toast.error("bạn chưa chọn kích thước của sản phẩm", {
//                 position: toast.POSITION.TOP_CENTER,
...
//             // co roi
//             if (availProduct.length !== 0) {
//                 availProduct[0].quantity += 1;
//                 currentAccount.products[availProduct[0].index] = availProduct[0].item;
//                 console.log(availProduct[0], "availProduct");
//                 toast.info("Thêm sản phẩm vào giở hàng thành công", {
//                     position: toast.POSITION.TOP_CENTER,
//                 });
//             } else {
...
//                         <Carousel data-bs-theme="dark">
//                             <Carousel.Item>
//                                 <img className="d-block " src={state.img1} alt="First slide" />
//                             </Carousel.Item>
//                             <Carousel.Item>
//                                 <img className="d-block " src={state.img2} alt="First slide" />
//                             </Carousel.Item>
//                             <Carousel.Item>
//                                 <img className="d-block " src={state.img3} alt="First slide" />
//                             </Carousel.Item>
//                             <Carousel.Item>
//                                 <img className="d-block " src={state.img4} alt="First slide" />
//                             </Carousel.Item>
//                             <Carousel.Item>
//                                 <img className="d-block " src={state.img5} alt="First slide" />
//                             </Carousel.Item>
//                         </Carousel>
//                     </div>
//                     <div className="product-info">
...
//                                         <div className="handle-price">
//                                             <p className="price-new">
//                                                 {formatCurrency(state.price - state.price * (state.salecost / 100))}
//                                                 <span className="salecost"> -{state.salecost}%</span>
//                                             </p>
//                                             <p className="price-old text-center">{formatCurrency(state.price)}</p>
//                                         </div>
//                                     ) : (
//                                         <div>
//                                             <Card.Text className="price_product">{formatCurrency(state.price)}</Card.Text>
//                                         </div>
//                                     )}
//                                 </div>
//                                 <Card.Text className="mx-0">
//                                     Màu sắc: <span className="text-uppercase fw-bolder">{state.color}</span>
//                                 </Card.Text>
//                                 <Card.Img className="img-card" variant="bottom" src={state.img1} />
//                                 <div className="size">
//                                     <div className="title-pick d-flex">
//                                         <span>Kích Thước</span>
//                                         <a href="">hướng dẫn chọn kích thước</a>
//                                     </div>
//                                     {state.category == "leather" || state.type == "accessory" ? (
//                                         (state.size = "")
//                                     ) : (
//                                         <ul className="size-pick d-flex">
//                                             <li onClick={() => handleActiveBtn(37)}>
...
//                                     </h6>
//                                     <Collapse in={open}>
//                                         <p id="example-collapse-text">{state.description}</p>
//                                     </Collapse>
//                                 </div>
//                                 <h6 className="my-3">Ưu đãi thanh toán VNPay</h6>
//                                 <p>Nhập VNPAYXINH Giảm 100K cho đơn từ 1.500.000 vnđ và 200K cho hóa đơn từ 3.500.000 vnđ</p>
